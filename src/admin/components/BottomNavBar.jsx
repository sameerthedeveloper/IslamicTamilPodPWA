...
function BottomNavBar() {
  ...
  return (
    <nav
      className="fixed inset-x-3 bottom-[max(0.75rem,calc(env(safe-area-inset-bottom)+0.35rem))] z-30 rounded-full border p-2 shadow-xl backdrop-blur-sm lg:hidden"
