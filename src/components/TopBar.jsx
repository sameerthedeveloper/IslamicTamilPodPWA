...
function TopBar() {
  return (
        <header
            className=" sticky top-0 z-50 flex min-h-20 shrink-0 items-center justify-between border-b border-gray-200 bg-gray-100/95 px-5 shadow-sm backdrop-blur pt-15 pb-4">
