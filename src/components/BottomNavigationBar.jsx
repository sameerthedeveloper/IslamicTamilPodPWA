...
function BottomNavigationBar() {
    return (
        <nav className="fixed inset-x-5 bottom-3 z-50 rounded-full border border-gray-200 bg-white/95 p-2 shadow-xl backdrop-blur-sm sm:left-1/2 sm:right-auto sm:w-full sm:max-w-116 sm:-translate-x-1/2 lg:hidden">
