...
function BottomNavigationBar() {
    return (
        <nav className="fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-50 rounded-[28px] border border-gray-200 bg-white/95 p-2 shadow-xl backdrop-blur-sm">
