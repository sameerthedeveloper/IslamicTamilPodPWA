...
function TopicChip({ name, icon: Icon, index = 0, active = false, onClick }) {
  return (
    <motion.button
      onClick={onClick}
      ...
      className="flex shrink-0 items-center gap-2 rounded-full border py-2 pl-2.5 pr-4 shadow-sm transition-shadow duration-200 hover:shadow-md"
      style={{
