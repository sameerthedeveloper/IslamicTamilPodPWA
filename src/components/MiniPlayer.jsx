...
function MiniPlayer() {
    ...
    return (
        <div id="mini-player"
            className="fixed inset-x-10 bottom-[calc(6rem+env(safe-area-inset-bottom))] z-40 flex items-center justify-between rounded-full border border-gray-200 bg-white px-4 py-2 shadow-lg">
